...
class StudentViewSet(viewsets.ModelViewSet):
    ...
    def bulletin(self, request, pk=None):
        """
        Generate and download unified bulletin (Boletim) PDF for a student.
        Contains: personal data, grades, attendance, and disciplinary records.
        """
        ...
        # Use existing report generation function for comprehensive data
        report_data = generate_student_academic_report(student)
        
        # Prepare context for unified bulletin template
        context = {
            'student': student,
    ...
    def academic_history(self, request, pk=None):
        ...
        This endpoint now redirects to the unified bulletin which includes all academic information.
        """
        # Redirect to unified bulletin endpoint
        return self.bulletin(request, pk)
