export default function Home() {
	return (
		<div className="flex w-screen h-screen text-gray-200 bg-gray-900">
			<div className="flex flex-col w-64 border-r border-gray-800 bg-gray-900">
				<button className="relative text-sm focus:outline-none group">
					<div className="flex items-center justify-between w-full h-16 px-4 border-b border-gray-800 hover:bg-gray-800 transition-colors duration-200">
					...
					<div className="absolute z-10 flex-col items-start hidden w-full pb-1 bg-gray-800 border border-gray-700 shadow-lg group-focus:flex top-16">
						<a
				...
				<div className="flex flex-col flex-grow p-4 overflow-auto">
					<a
						className="flex items-center flex-shrink-0 h-10 px-2 text-sm font-medium rounded hover:bg-gray-800 transition-colors duration-200"
						href="#"
					>
						<svg
					...
					<a
						className="flex items-center flex-shrink-0 h-10 px-3 mt-auto text-sm font-medium bg-gray-800 rounded hover:bg-gray-700 transition-colors duration-200"
						href="#"
					>
						<svg
			...
			<div className="flex flex-col flex-grow bg-gray-900">
				<div className="flex items-center flex-shrink-0 h-16 px-8 bg-gray-800 border-b border-gray-700">
					...
					<div className="flex ml-auto">
						...
						<button className="relative ml-2 text-sm focus:outline-none group">
							...
							<div className="absolute right-0 flex-col items-start hidden w-40 pb-1 bg-gray-800 border border-gray-700 shadow-lg group-focus:flex">
								<a
									className="w-full px-4 py-2 text-left hover:bg-gray-700 transition-colors duration-200"
									href="#"
								>
				...
				<div className="flex-grow p-6 overflow-auto bg-gray-900">
					<div className="grid grid-cols-3 gap-6">
						<div className="h-48 col-span-1 p-4 bg-gray-800 border border-gray-700 rounded-lg">
						...
						<div className="h-48 col-span-2 p-4 bg-gray-800 border border-gray-700 rounded-lg">
							<h2 className="font-bold text-gray-300">
						...
						<div className="h-48 col-span-3 p-4 bg-gray-800 border border-gray-700 rounded-lg">
							<h2 className="font-bold text-gray-300">
								Feed de Atividades
							</h2>
							<p className="text-sm text-gray-400 mt-2">
						...
						<div className="h-48 col-span-2 p-4 bg-gray-800 border border-gray-700 rounded-lg"></div>
						<div className="h-48 col-span-1 p-4 bg-gray-800 border border-gray-700 rounded-lg"></div>
					</div>
				</div>
			</div>
		</div>
