...
describe('ResourcesPage', () => {
    ...
    it('should render error state', () => {
        ...
        expect(
            screen.getByText('Error: Erro ao carregar recursos'),
        ).toBeInTheDocument()
    })
    ...
    it('should render resources', async () => {
        ...
        await waitFor(() => {
            expect(
                screen.getByRole('heading', { name: 'Recursos', level: 1 }),
            ).toBeInTheDocument()
            expect(
                screen.getByText('Recursos disponíveis na escola'),
            ).toBeInTheDocument()
    ...
    it("should display 'No resources found' message when no resources exist", async () => {
        ...
        await waitFor(() => {
            expect(
                screen.getByText('Nenhum recurso encontrado.'),
            ).toBeInTheDocument()
        })
    })
})
