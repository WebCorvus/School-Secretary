...
export type ProfessorPostProps = Omit<ProfessorProps, "id" | "created_at" | "subject_details" | "user">;
...
export const FakeProfessorCompact: ProfessorCompactProps = createFakeProfessorCompact();