...
export interface GradeCompactProps {
	id: number;
	student: number;
	subject: number;
	year: number;
...
export function createFakeGradeCompact(year?: number): GradeCompactProps {
	return {
		id: faker.number.int(),
...
export const FakeGradeCompact: GradeCompactProps = createFakeGradeCompact();
...
export type GradePostProps = Omit<
	GradeProps,
	"id" | "created_at" | "student_details" | "subject_details"
>;
