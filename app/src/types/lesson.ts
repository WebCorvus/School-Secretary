...
import { ProfessorCompactProps, createFakeProfessorCompact } from "./professor";
...
export type LessonPostProps = Omit<LessonProps, "id" | "created_at" | "group_details" | "professor_details" | "subject_details">;
